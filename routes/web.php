...
Route::middleware(['auth', 'role:admin|super-admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/qquestions', \App\Livewire\QuestionBank\Index::class)->name('question-bank.index');
    ...
    // Exam Management
    Route::get('/exams', \App\Livewire\Admin\Exams\Index::class)->name('admin.exams.index');
    Route::get('/exams/create', \App\Livewire\Admin\Exams\Create::class)->name('admin.exams.create');
    ...
    Route::get('/exams/submissions', \App\Livewire\Admin\Exams\Submissions::class)->name('admin.exams.submissions');
