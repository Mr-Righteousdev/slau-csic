<div>
    ...
    @endif
            ...
            <x-filament::modal width="2xl" class="z-9999999 modal fixed inset-0" id="create-meeting-modal" slide-over>
                <x-slot name="heading">
                Add New Meeting
                </x-slot>
            {{-- Form --}}
                <form wire:submit="submit" class="space-y-6 z-index-9999999">
                    {{-- Meeting Title --}}
                    <div>
                    ...
                    <div class="flex items-center justify-end space-x-3 pt-4 border-t">
                        ...
                        <button
                            type="button"
                            wire:click="closeAddMeetingModal"
                            class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition"
                        >
                            Reset
                        </button>
