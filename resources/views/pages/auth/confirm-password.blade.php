...
@section('content')
    <div class="portal-shell relative min-h-screen overflow-hidden">
        ...
        <div class="portal-orb portal-orb-secondary left-[8%] top-[12%] h-48 w-48"></div>
        <div class="portal-orb portal-orb-primary bottom-[8%] right-[12%] h-54 w-54"></div>
        ...
        <div class="relative z-10 flex min-h-screen flex-col lg:flex-row">
            <section class="flex w-full lg:w-[46%]">
                <div class="mx-auto flex w-full max-w-xl flex-1 flex-col justify-center px-6 py-12 sm:px-10 lg:px-14">
                    ...
                    <div class="mb-8">
                        <p class="text-sm font-medium uppercase tracking-[0.28em]" style="color: var(--portal-secondary);">Secure Confirmation</p>
                        <h1 class="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl" style="color: var(--portal-text);">Confirm your password</h1>
                        <p class="portal-copy mt-4 max-w-lg text-sm leading-7 sm:text-base">
                            This is a protected action. Confirm your password to continue inside the secure member environment.
                        </p>
                    </div>
            ...
            <section class="portal-shell-panel relative hidden lg:flex lg:w-[54%]">
                ...
                <div class="flex flex-1 items-end p-10 xl:p-14">
                    <div class="max-w-2xl">
                        <div class="portal-badge">Protected Action</div>
                        <h2 class="mt-6 text-4xl font-semibold tracking-tight text-white xl:text-5xl">
                            Sensitive actions should pass through a deliberate security check.
                        </h2>
                        <p class="portal-side-copy mt-5 max-w-xl text-base leading-8">
                            This confirmation step keeps administrative and high-trust actions inside a stronger security boundary while maintaining the same visual quality as the rest of the platform.
                        </p>

                        <div class="portal-side-grid mt-8 sm:grid-cols-3">
                            <div class="portal-side-stat">
                                <div class="portal-side-stat-value">Protected</div>
                                <div class="portal-side-stat-label">Sensitive actions</div>
                            </div>
                            <div class="portal-side-stat">
                                <div class="portal-side-stat-value">Trusted</div>
                                <div class="portal-side-stat-label">Member access</div>
                            </div>
                            <div class="portal-side-stat">
                                <div class="portal-side-stat-value">Unified</div>
                                <div class="portal-side-stat-label">Portal experience</div>
                            </div>
                        </div>
                    </div>
                </div>
