...
@section('content')
    <div class="portal-shell relative min-h-screen overflow-hidden">
        ...
        <div class="portal-orb portal-orb-secondary left-[10%] top-[12%] h-48 w-48"></div>
        <div class="portal-orb portal-orb-primary bottom-[8%] right-[10%] h-60 w-60"></div>
        ...
        <div class="relative z-10 flex min-h-screen flex-col lg:flex-row">
            <section class="flex w-full lg:w-[46%]">
                <div class="mx-auto flex w-full max-w-xl flex-1 flex-col justify-center px-6 py-12 sm:px-10 lg:px-14">
                    ...
                    <div class="mb-8">
                        <p class="text-sm font-medium uppercase tracking-[0.28em]" style="color: var(--portal-secondary);">Reset Credentials</p>
                        <h1 class="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl" style="color: var(--portal-text);">Set a new secure password</h1>
                        <p class="portal-copy mt-4 max-w-lg text-sm leading-7 sm:text-base">
                            Complete the reset by confirming your email address and choosing a new password for your member account.
                        </p>
                    </div>
                    ...
                    <div class="portal-card rounded-md p-6 sm:p-8">
                        <form method="POST" action="{{ route('password.store') }}">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    <label class="portal-copy mb-2 block text-sm font-medium">
                                        New password <span style="color: var(--portal-primary);">*</span>
                                    </label>
                                ...
                                <div>
                                    <label class="portal-copy mb-2 block text-sm font-medium">
                                        Confirm password <span style="color: var(--portal-primary);">*</span>
                                    </label>
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input
                                            :type="showPassword ? 'text' : 'password'"
                                            ...
                                            class="portal-field h-12 w-full rounded-sm px-4 pr-12 text-sm placeholder:text-slate-500 focus:border-emerald-400 focus:outline-none focus:ring-4 focus:ring-emerald-400/10"
                                        />
                                        <button type="button" @click="showPassword = !showPassword" class="portal-muted absolute inset-y-0 right-4 inline-flex items-center">
                                            <svg x-show="!showPassword" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.0002 13.8619C7.23361 13.8619 4.86803 12.1372 3.92328 9.70241C4.86804 7.26761 7.23361 5.54297 10.0002 5.54297C12.7667 5.54297 15.1323 7.26762 16.0771 9.70243C15.1323 12.1372 12.7667 13.8619 10.0002 13.8619ZM10.0002 4.04297C6.48191 4.04297 3.49489 6.30917 2.4155 9.4593C2.3615 9.61687 2.3615 9.78794 2.41549 9.94552C3.49488 13.0957 6.48191 15.3619 10.0002 15.3619C13.5184 15.3619 16.5055 13.0957 17.5849 9.94555C17.6389 9.78797 17.6389 9.6169 17.5849 9.45932C16.5055 6.30919 13.5184 4.04297 10.0002 4.04297ZM9.99151 7.84413C8.96527 7.84413 8.13333 8.67606 8.13333 9.70231C8.13333 10.7286 8.96527 11.5605 9.99151 11.5605H10.0064C11.0326 11.5605 11.8646 10.7286 11.8646 9.70231C11.8646 8.67606 11.0326 7.84413 10.0064 7.84413H9.99151Z" fill="currentColor" />
            ...
            <section class="portal-shell-panel relative hidden lg:flex lg:w-[54%]">
                ...
                <div class="flex flex-1 items-end p-10 xl:p-14">
                    <div class="max-w-2xl">
                        <div class="portal-badge">Credential Reset</div>
                        <h2 class="mt-6 text-4xl font-semibold tracking-tight text-white xl:text-5xl">
                            Security flows should feel precise, not generic.
                        </h2>
                        <p class="portal-side-copy mt-5 max-w-xl text-base leading-8">
                            This reset screen follows the same premium visual system as the rest of the portal, giving password changes a more trustworthy and polished experience.
                        </p>

                        <div class="portal-side-grid mt-8 sm:grid-cols-3">
                            <div class="portal-side-stat">
                                <div class="portal-side-stat-value">Protected</div>
                                <div class="portal-side-stat-label">Reset workflow</div>
                            </div>
                            <div class="portal-side-stat">
                                <div class="portal-side-stat-value">Clear</div>
                                <div class="portal-side-stat-label">Field structure</div>
                            </div>
                            <div class="portal-side-stat">
                                <div class="portal-side-stat-value">Unified</div>
                                <div class="portal-side-stat-label">Portal design</div>
                            </div>
                        </div>
                    </div>
                </div>
